...
//        return new Member("Samwise", "Gamgee", "New member", 20, 0);
//    }
//
//    @Before
...
//        assertEquals(0, memb.getAll().size());
//    }
//
//    @Test
...
//        Member testMember = setupMember();
//        Member otherTestMember = setupMember();
//        assertEquals(2, memberDao.findById(otherTestMember.getId()).getId());
//    }
//
//    // Getter Methods
//    @Test
...
//        assertTrue(mem.getAll().contains(otherTestMember));
//    }
//
//    @Test
